...
extension UserEntity {
    convenience init(
        ...
        self.init(
            ...
            instagramIdentifier: register.instagramIdentifier,
            xIdentifier: register.xIdentifier,
            threadsIdentifier: register.threadsIdentifier,
            tiktokIdentifier: register.tiktokIdentifier,
